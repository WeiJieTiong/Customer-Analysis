...
class CentroidTracker:
    def __init__(self, maxDisappeared=50, maxDistance=50):
        ...
        # store the maximum distance between centroids to associate an object -- if the distance is larger than this maximum
    ...
    def update(self, rects):
        ...
        for (i, (startX, startY, endX, endY)) in enumerate(rects):
            ...
            inputCentroids[i] = (cX, cY)               #record centroid
        ...
        # otherwise, are are currently tracking objects so we need to try to match the input centroids to existing object centroids
            ...
            objectIDs = list(self.objects.keys())          #objectIDs = [nextObjectID, 1,2,3,4]
